...
1. Open the [beta Release](https://github.com/K-K-Szostak/marginalia-local-search/releases/tag/v0.1.0-beta.12).
2. Download **`Marginalia-v0.1.0-beta.12.zip`**. Do not download the
